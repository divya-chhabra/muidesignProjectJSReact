...
import { Tooltip, Fab, Modal, Box, Button, ButtonGroup,Typography, Avatar, TextField, Stack } from '@mui/material';
            ...
            >
                <Box width={400} height={280} bgcolor={"background.default"} color={"text.primary"} p={3} borderRadius={3}>
                    ...
                    <UserBox>
                        ...
                        <Typography fontWeight={500} variant='span'>Divya Chhabra</Typography>
                    </UserBox>
